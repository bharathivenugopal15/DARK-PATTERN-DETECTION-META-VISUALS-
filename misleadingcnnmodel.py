...
train_path = r'C:\Users\Kasey\OneDrive\Documents\sih\image correction analysis main\ml\misleading_train'
validation_path = r'C:\Users\Kasey\OneDrive\Documents\sih\image correction analysis main\ml\misleading_val'
test_path = r'C:\Users\Kasey\OneDrive\Documents\sih\image correction analysis main\ml\misleading_val'
...
train_generator = train_datagen.flow_from_directory(
    ...
    classes=['misleading', 'not_misleading']
)
...
print("Number of steps per epoch:", train_generator.samples // batch_size)
...
cnn_model.save('misleading_cnnmodel.h5')
'''
import numpy as np
...
test_image_path = '/content/drive/MyDrive/imagedataset/images/train/not_misleading/41310.jpg'
